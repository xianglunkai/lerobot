...
from lerobot.vae.dict_of_tensor_mixin import DictOfTensorMixin
...
ArrayLike = Union["Dict", torch.Tensor, np.ndarray, Any]
...
class SingleFieldLinearNormalizer(DictOfTensorMixin):
    ...
    @classmethod
    def create_fit(cls, data: Union[torch.Tensor, np.ndarray, Any], **kwargs):
        obj = cls()
        obj.fit(data, **kwargs)
        return obj
